...
ALTER TABLE `access_rights` ADD COLUMN `type` enum('useractions','transactions','superadmin') CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL AFTER `access_right_code`;

INSERT INTO access_rights (access_right_code, name, type, description, status, created_at, updated_at) VALUES
('SAR_001', 'CREATE-USER', 'useractions', 'this is a test role CREATE-USER', 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SAR_002', 'VIEW-USER', 'useractions', 'this is a test role VIEW-USER', 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SAR_003', 'DELETE-USER', 'useractions', 'this is a test role DELETE-USER', 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SAR_004', 'UPDATE-USER', 'useractions', 'this is a test role UPDATE-USER', 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
